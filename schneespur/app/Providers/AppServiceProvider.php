...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(HelpTopicRegistry::class);
    ...
    private function registerCoreNavigation(): void
    {
        ...
        $nav->addGroup('top', '', 0);
        $nav->addGroup('stammdaten', 'admin.nav_group_master_data', 10);
        $nav->addGroup('einsaetze', 'admin.nav_group_operations', 20);
        $nav->addGroup('auswertungen', 'admin.nav_group_reports', 30);
        $nav->addGroup('system', 'admin.nav_group_system', 40);
        ...
        $nav->addItem(
            ...
            label: 'admin.nav_archived_drivers',
        ...
        $nav->addItem(
            group: 'auswertungen',
            slug: 'overview-daily',
            label: 'admin.nav_overview_daily',
        ...
        $nav->addItem(
            ...
            label: 'admin.nav_overview_monthly',
        ...
        $nav->addItem(
            ...
            label: 'admin.nav_overview_driver_report',
        ...
        $nav->addItem(
            ...
            label: 'admin.nav_overview_customer_report',
